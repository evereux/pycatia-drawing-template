...
def create_copyright_box(sheet: DrawingSheet, parameters: Parameters):
    ...
    box_height = 30
    box_width = 130
    top_line = factory_2d.create_line(border_offset, border_offset + box_height, border_offset + box_width, border_offset + box_height)
    right_line = factory_2d.create_line(border_offset + box_width, border_offset, border_offset + box_width, border_offset + box_height)
