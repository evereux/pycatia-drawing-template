...
from application.background_view import get_background_view_and_factory
from application.settings import border_offset
from application.settings import company_details
from application.settings import logo
from application.settings import tolerances
from application.settings import units
from application.text_properties import set_text_properties
...
def create_title_block(sheet: DrawingSheet,
    ...
    h1 = {"x_start": bottom_left_hand_corner_x, "x_end": bottom_left_hand_corner_x + title_block_width, "y": bottom_left_hand_corner_y}
    h2 = {"x_start": bottom_left_hand_corner_x, "x_end": bottom_left_hand_corner_x + title_block_width, "y": bottom_left_hand_corner_y + line_height}
    h3 = {"x_start": bottom_left_hand_corner_x, "x_end": bottom_left_hand_corner_x + title_block_width, "y": bottom_left_hand_corner_y + line_height *3}
    h4 = {"x_start": bottom_left_hand_corner_x, "x_end": bottom_left_hand_corner_x + title_block_width, "y": bottom_left_hand_corner_y + line_height *5}
    h5 = {"x_start": bottom_left_hand_corner_x, "x_end": bottom_left_hand_corner_x + title_block_width, "y": bottom_left_hand_corner_y + line_height *7} # top horizontal line
    
    # dims for complete vertical lines
    v1 = {"x": bottom_left_hand_corner_x, "y_start": bottom_left_hand_corner_y, "y_end": bottom_left_hand_corner_y + title_block_height} # first vertical line
    v2_x_offset = 65
    v2 = {"x": bottom_left_hand_corner_x + v2_x_offset, "y_start": bottom_left_hand_corner_y, "y_end":  bottom_left_hand_corner_y + title_block_height}
    v3_x_offset = 138
    v3 = {"x": bottom_left_hand_corner_x + v3_x_offset, "y_start": bottom_left_hand_corner_y, "y_end":  bottom_left_hand_corner_y + title_block_height}
    v4 = {"x": bottom_left_hand_corner_x + title_block_width, "y_start": bottom_left_hand_corner_y, "y_end":  bottom_left_hand_corner_y + title_block_height}

    # dims for partial vertical lines
    v1_1_x_offset = bottom_left_hand_corner_x + 28
    v1_1 = {"x": v1_1_x_offset, "y_start": bottom_left_hand_corner_y + line_height * 3, "y_end": bottom_left_hand_corner_y + title_block_height}
    
    v2_1_x_offset = v2['x'] + 46
    v2_1 = {"x": v2_1_x_offset, "y_start": bottom_left_hand_corner_y + line_height * 3, "y_end": bottom_left_hand_corner_y + line_height * 5}
    
    v2_2_x_offset = v2_1_x_offset + 13.5
    v2_2 = {"x": v2_2_x_offset, "y_start": bottom_left_hand_corner_y + line_height * 3, "y_end": bottom_left_hand_corner_y + line_height * 5}
    
    v3_1_x_offset = v3['x'] + 12
    v3_1 = {"x": v3_1_x_offset, "y_start": bottom_left_hand_corner_y + line_height, "y_end": bottom_left_hand_corner_y + line_height * 3}
    ...
    v3_4 = {"x": v3_4_x_offset, "y_start": bottom_left_hand_corner_y + line_height, "y_end": bottom_left_hand_corner_y + line_height * 3}
